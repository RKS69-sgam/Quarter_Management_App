                ...
                if vacant_qs:
                    ...
                    if st.button("Process Allotment & Generate Letter"):
                        ...
                        if doc:
                            ...
                            st.download_button("📥 Download Allotment Letter", buf.getvalue(), f"Quarter_Allotment_{emp_info.get('Employee Name')}.docx")
                else:
        ...
        if not occ_df.empty:
            ...
            if st.button("Vacate & Generate Letter"):
                ...
                if doc:
                    ...
                    st.download_button("📥 Download Vacation Letter", buf.getvalue(), f"Quarter_Vacation_{sel_v}.docx")
        else:
